...
import 'package:movieapp/components/horizontal.dart';
...
class _SearchMoviesState extends State<SearchMovies> {
  ...
  Future<Trending> fetchMovies() async {
    ...
    final response = await http.get(Uri.parse(
        "https://api.themoviedb.org/3/trending/movie/day?api_key=c988249a321d1e6e27647c9a5e601b9e&language=en-US&query=$movieName&include_adult=false"));
